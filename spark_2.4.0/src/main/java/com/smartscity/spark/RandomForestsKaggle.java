...
/**
 * Score  : 0.8886987035251259
 *          by  pom spark-core_2.11  version:2.4.0
 */
...
// Converting string labels into indices.
        ...
        OneHotEncoderEstimator embEncoder = new OneHotEncoderEstimator().setInputCols( new String[]{"EmbarkedIndexed"} ).setOutputCols( new String[]{"EmbarkedVec"} );
        OneHotEncoderEstimator sexEncoder = new OneHotEncoderEstimator().setInputCols( new String[]{"SexIndexed"} ).setOutputCols( new String[]{"SexVec"} );
        OneHotEncoderEstimator titleEncoder = new OneHotEncoderEstimator().setInputCols( new String[]{"TitleIndexed"} ).setOutputCols( new String[]{"TitleVec"} );
